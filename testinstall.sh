...
pacman -Sy
pacman -noconfirm -S git zsh neovim bashtop kitty make go python cargo dunst lazygit rofi npm unzip awesome-terminal-fonts xdotool ripgrep rust-src docker playerctl yazi xsel fzf bluetoothctl
